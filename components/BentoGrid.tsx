...
export const BentoCard = forwardRef<HTMLDivElement, BentoCardProps>(
  ({ 
    ...
    const variantClasses = {
      default: 'card-modern',
      featured: 'glass-medium border-accent-blue/20 bg-gradient-to-br from-accent-blue/5 to-accent-purple/5',
      minimal: 'glass-light border-border',
      gradient: 'bg-gradient-to-br from-accent-blue/10 via-accent-purple/10 to-accent-orange/10 border-accent-blue/20'
    }
  ...
  return (
    <BentoCard size={size} variant="minimal">
      <div className="h-full flex flex-col justify-center p-6 text-center">
        ...
        {change && (
          <div className={cn('text-xs flex items-center justify-center', trendColors[trend])}>
...
export const PersonaBento = ({
  ...
  return (
    <BentoCard 
      size={size} 
      variant={active ? 'featured' : 'default'}
    >
